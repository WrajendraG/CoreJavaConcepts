package com.coreJava.PreDefinedClasses;
...
public class StringBuilderMethodDemo
{
    public static void main (String args[])
    {
        ...
        StringBuilder str1= new StringBuilder("Rajendra");
        ...
        System.out.print("\n length of string After Trim :"+buff6.length());
        buff6.trimToSize();            // trimToSize buffer
        System.out.println("\nProgramming :  " + buff6);
        System.out.print("\n length of string Before Trim :"+buff6.length());
